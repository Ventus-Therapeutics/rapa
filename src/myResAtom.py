...
class myResidue(Bio.PDB.Residue.Residue):
    '''
    Defining a class of myResidue that inherits biopython residue 
    ...
    def get_child_list_myatoms(self,residue):
        '''
        objective: to get list of atoms in the residue
        input:residue-for which its atoms are needed
        output: list of child atoms
        '''
        myChildAtoms = []
        for atom in residue.child_list:
            myChildAtoms.append(myAtom(atom))
        return myChildAtoms
...
##defining the active atoms of unknown residue
    def get_unknownResActiveAtoms(self):
        '''
...
class myAtom(Bio.PDB.Atom.Atom): 

    '''
    Defining a class of myAtom that inherits biopython atom
    ...
    def __init__(self, atom):
        ...
        self.atomBehavior = self.set_defaultBehavior()
...
#Get the name of parent residue of the atom
    def get_atomParentName(self):
        ''' Get the name of parent residue of the atom'''
        return self.parent.resname


    def get_parentResOfAtom(self):
        ''' Returns name of the parent residue'''
        return self.get_parent()


    def set_defaultBehavior(self):
            '''O/P: Provides the behavior of atom as 
               donor/acceptor/both/none/TBD based on the name of the atom and parent name  '''

            atomParentName = self.get_atomParentName()
